...
parser.add_argument('--decoder', default='D_CAGraph', help='what decoder to use.')
...
dataset = dl.train(input_img_rcnn=opt.input_img_rcnn_train, input_ques_h5=opt.input_ques_h5,
...
def train(epoch):
    ...
    while i < len(dataloader):
        ...
        if i % opt.log_interval == 0:
            average_loss /= count
            print("step {} / {} (epoch {}), d_loss {:.3f}, lr = {:.6f}"\
